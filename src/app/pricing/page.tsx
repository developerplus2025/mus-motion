...
function PricingPage() {
  ...
  return (
    <main className="pb-[6rem]">
      ...
      <motion.div initial={{height:"100vh"}} animate={{top:"0",height:"0vh"}} transition={{duration:3,delay:1}} className="top-[100%] flex items-center justify-center h-[100vh]  z-[50] bg-[black] fixed  w-screen ">
